...
(define (ziku-main halt)
  (let ((done halt)) (let ((_alpha0 done)) (let ((x 5)) (let ((_alpha1 _alpha0)) (let ((y 10)) (let ((_alpha2 _alpha1)) (let ((_alpha3 (lambda (_f0) (if _f0 (let ((_alpha4 _alpha2)) (let ((%p x)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) done) (done %p)))) (let ((_alpha5 _alpha2)) (_alpha5 (+ x y))))))) (_alpha3 (> x y))))))))))
