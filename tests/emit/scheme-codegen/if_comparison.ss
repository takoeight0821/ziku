...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (let ((_alpha1 (lambda (_f0) (if _f0 (let ((%p 42)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))) (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))))))) (_alpha1 (> 5 3)))))
