...
(define (ziku-main halt)
  (let ((outer halt)) (let ((inner outer)) (let ((_alpha0 inner)) (let ((_alpha1 (lambda (_f0) (if _f0 (let ((_alpha2 _alpha0)) (let ((%p 100)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) inner) (inner %p)))) (let ((_alpha3 _alpha0)) (let ((%p 42)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) outer) (outer %p)))))))) (_alpha1 (equal? 1 0)))))))
