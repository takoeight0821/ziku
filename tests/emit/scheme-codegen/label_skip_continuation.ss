...
(define (ziku-main halt)
  (let ((done halt)) (let ((_alpha0 done)) (let ((_alpha1 (lambda (_f0) (_alpha0 (+ _f0 100))))) (let ((%p 42)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) done) (done %p)))))))
