...
(define (ziku-main halt)
  (let ((result halt)) (let ((_alpha0 result)) (if #t (let ((_alpha1 _alpha0)) (let ((%p 100)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) result) (result %p)))) (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p)))))))
