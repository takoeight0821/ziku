...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (let ((s1 "hello")) (let ((_alpha1 _alpha0)) (let ((s2 "hello")) (let ((_alpha2 _alpha1)) (let ((s3 "world")) (let ((_alpha3 _alpha2)) (let ((_alpha4 (lambda (_f0) (if _f0 (let ((_alpha5 _alpha3)) (let ((_alpha6 (lambda (_f1) (if _f1 (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha5) (_alpha5 %p))) (let ((_alpha7 _alpha5)) (let ((_alpha8 (lambda (_f2) (if _f2 (let ((%p 1)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha7) (_alpha7 %p))) (let ((%p 2)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha7) (_alpha7 %p))))))) (_alpha8 (ziku-ne s1 s3)))))))) (_alpha6 (equal? s2 s3)))) (let ((%p 3)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha3) (_alpha3 %p))))))) (_alpha4 (equal? s1 s2)))))))))))
