...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (let ((%p (lambda (n) (lambda (_alpha1) (let ((_alpha2 _alpha1)) (_alpha2 (* n n))))))) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) (lambda (%fn0) (let ((%arg 5)) (if (and (vector? %arg) (eq? (vector-ref %arg 0) 'ziku-thunk)) ((vector-ref %arg 1) (lambda (%v) ((%fn0 %v) _alpha0))) ((%fn0 %arg) _alpha0))))) ((lambda (%fn0) (let ((%arg 5)) (if (and (vector? %arg) (eq? (vector-ref %arg 0) 'ziku-thunk)) ((vector-ref %arg 1) (lambda (%v) ((%fn0 %v) _alpha0))) ((%fn0 %arg) _alpha0)))) %p)))))
