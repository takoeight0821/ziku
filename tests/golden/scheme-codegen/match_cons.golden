...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (let ((%p (list 'Cons 42 (list 'Nil)))) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) (lambda (%v) (let ((%tag (car %v))) (cond ((eq? %tag 'Cons) (let ((x (list-ref %v 1)) (xs (list-ref %v 2))) (let ((%p x)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))))) ((eq? %tag 'Nil) (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p)))))))) ((lambda (%v) (let ((%tag (car %v))) (cond ((eq? %tag 'Cons) (let ((x (list-ref %v 1)) (xs (list-ref %v 2))) (let ((%p x)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))))) ((eq? %tag 'Nil) (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))))))) %p)))))
