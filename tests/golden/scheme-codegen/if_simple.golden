...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (if #t (let ((%p 1)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))) (let ((%p 0)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) _alpha0) (_alpha0 %p))))))
