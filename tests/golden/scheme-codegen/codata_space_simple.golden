...
(define (ziku-main halt)
  (let ((_alpha0 halt)) (let ((add1 (lambda (x) (lambda (_alpha1) (let ((_alpha2 _alpha1)) (_alpha2 (+ x 1))))))) (let ((_alpha3 _alpha0)) (let ((%p add1)) (if (and (vector? %p) (eq? (vector-ref %p 0) 'ziku-thunk)) ((vector-ref %p 1) (lambda (%fn0) (let ((%arg 10)) (if (and (vector? %arg) (eq? (vector-ref %arg 0) 'ziku-thunk)) ((vector-ref %arg 1) (lambda (%v) ((%fn0 %v) _alpha3))) ((%fn0 %arg) _alpha3))))) ((lambda (%fn0) (let ((%arg 10)) (if (and (vector? %arg) (eq? (vector-ref %arg 0) 'ziku-thunk)) ((vector-ref %arg 1) (lambda (%v) ((%fn0 %v) _alpha3))) ((%fn0 %arg) _alpha3)))) %p)))))))
